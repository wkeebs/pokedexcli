...
func (c *Client) GetPokemonSpecies(name string) (PokemonResponse, error) {
	...
	if err != nil {
		return PokemonResponse{}, fmt.Errorf("error sending request: %w", err)
	}
